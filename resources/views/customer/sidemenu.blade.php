    ...
    <div class="menuParent attendeeMenuParent d-flex flex-column" style="padding-bottom: 120px">
        <div class="d-none d-lg-block pt-1 pe-1 arrow-sticky">
            <div class="d-flex justify-content-end align-items-center">
                <i class=" icon-color las la-chevron-circle-left left-menu-icon-dashboard activeMenuItem fs-2"></i>
            </div>
        </div>
        ...
        <ul class="menuUl pt-0 ps-0">
            <li class="menuLi d-flex align-items-center leftMenuActive">
                ...
                <span class="menuCon d-flex justify-content-between align-items-center gap-2"><span>Home</span></span>
            </li>
            <li class="menuLi d-flex align-items-center">

                <i class="icon-color menuIcon las la-calendar-plus fs-2" data-tooltip="Events"></i>

                <span class="menuCon d-flex justify-content-between align-items-center gap-2"><span>Events</span></span>
            </li>
            ...
            <li class="menuLi d-flex align-items-center">
                ...
                <span class="menuCon d-flex justify-content-between align-items-center gap-2"><span>Orders</span></span>
            </li>
            <li class="menuLi d-flex align-items-center">
